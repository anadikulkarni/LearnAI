<template>
  <aside :class="['quiz-sidebar', { 'is-expanded': is_expanded }]">
  ...
  <div v-if="is_expanded" class="overlay" @click="toggleSidebar"></div>
</template>
...
const generateQuestions = async () => {
  ...
  try {
    let videoId = localStorage.getItem('video_id') || 'RBSUwFGa6Fk';
